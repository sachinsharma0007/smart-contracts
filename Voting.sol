...
contract Voting {
    ...
    function getTopWinners()public view returns (uint, string memory, uint,uint, string memory, uint,uint, string memory, uint)
    {
        ...
        return (
            topWinners[0].id, first.name, first.voteCount, // change 
